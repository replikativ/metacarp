...
Status: API version 4 implemented; this document retains the original design rationale
...
Types and schemes are exposed as rendered strings in API version 4. This keeps
...
`upsert` accepts exactly one top-level definition form in API version 4. A
...
Completion ranking and fuzzy matching remain host concerns in API version 4;
...
- Creating a session against a valid core succeeds and exposes API version 4.
